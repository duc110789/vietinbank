...
class MerchantList extends Component {
  ...
  componentDidMount() {
    setTimeout(() => {
      ...
      if (searchParams && searchParams.merchantListDenied) {
        this.setState({
          currentPage: searchParams.merchantListDenied.fromRow / searchParams.merchantListDenied.pageSize + 1,
          perPage: searchParams.merchantListDenied.pageSize,
        });
      }
    }, 0);
  }
  ...
  handlePageChange = (pageNumber) => {
    ...
    if (
      ...
      this.setState({
        ...
        storedData = {
          ...(storedData && storedData.merchantListDenied) || defaultData,
    ...
    return (
      <>
        <div className="animated fadeIn fee-table" style={{ background: 'white' }}>
          <Card>
            <CardHeader>
              <span className="text-bold">{Constants.MerchantList.merchantListDenied}</span>
            </CardHeader>
            <CardBody>
              <FillMerchant
