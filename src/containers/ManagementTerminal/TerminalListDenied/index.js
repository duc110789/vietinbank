...
class TerminalListDenied extends Component {
  constructor(props) {
    super(props);
    this.state = {
      currentPage: 1,
  ...
  componentDidMount() {
    setTimeout(() => {
      ...
      if (searchParams && searchParams.terminalListDenied) {
        this.setState({
          currentPage: searchParams.terminalListDenied.fromRow / searchParams.terminalListDenied.pageSize + 1,
          perPage: searchParams.terminalListDenied.pageSize,
        });
      }
    }, 0);
  }
  ...
  handlePageChange = (pageNumber) => {
    ...
    if (
      ...
      this.setState({
        ...
        storedData = {
          ...(storedData && storedData.terminalListDenied) || defaultData,
    ...
    return (
      <>
        <div className="animated fadeIn fee-table" style={{ background: 'white' }}>
          <Card>
            <CardHeader>
              <span className="text-bold">{Constants.TerminalList.terminalListDenied}</span>
            </CardHeader>
            <CardBody>
              <FillMerchant
