...
class ContactInfo extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps.terminalDetail !== terminalDetail) {
      const terminalDetailContact = terminalDetail && terminalDetail.terminalContact;
      this.setState({
        fullName: terminalDetailContact && terminalDetailContact.fullName,
        numberPhone: terminalDetailContact && terminalDetailContact.phoneNumber,
        numberPhone2: terminalDetailContact && terminalDetailContact.phoneNumber1,
        numberPhone3: terminalDetailContact && terminalDetailContact.phoneNumber2,
        email: terminalDetailContact && terminalDetailContact.email,
        email2: terminalDetailContact && terminalDetailContact.email1,
        email3: terminalDetailContact && terminalDetailContact.email2,
      });
    }
  }
