...
class BeneficiaryAccount extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (terminalDetail !== prevProps.terminalDetail) {
      const terminalDetailBeean = terminalDetail && terminalDetail.terminal;
      this.setState({
        accountNumber: terminalDetailBeean && terminalDetailBeean.accEnjoymentBean
          && terminalDetailBeean.accEnjoymentBean.accountNumber,
        accountOwn: terminalDetailBeean && terminalDetailBeean.accEnjoymentBean
          && terminalDetailBeean.accEnjoymentBean.accountHolder,
        bankCode: '970489',
        branchBank: {
          value: terminalDetailBeean && terminalDetailBeean.accEnjoymentBean
            ? terminalDetailBeean.accEnjoymentBean.accEnjoymentId : '',
          label: terminalDetailBeean && terminalDetailBeean.accEnjoymentBean
            ? terminalDetailBeean.accEnjoymentBean.branchName : '',
        },
        currency: 'VNĐ',
        accountTerminal: terminalDetailBeean && terminalDetailBeean.terminalAppUser,
      });
    }
  }
