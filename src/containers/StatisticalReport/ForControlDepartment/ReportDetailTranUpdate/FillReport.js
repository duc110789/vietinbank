...
import {getDetailTransactionUpdate, getExcelFileReportUpdate} from '../../../../store/actions/StatisticalReport/index';
...
class FillReport extends Component {
  ...
  componentDidMount() {
    const {
      getDetailTransactionUpdate, getMerchantCodeName,
    } = this.props;
    const sendData = {
    ...
    getDetailTransactionUpdate(sendData);
  }
  ...
  componentDidUpdate(prevProps) {
    const { exportReportFileUpdate } = this.props;
    if (prevProps.exportReportFileUpdate !== exportReportFileUpdate) {
      window.open(exportReportFileUpdate, 'blank');
    }
  }
  ...
  onHandleSearch = () => {
    ...
    getDetailTransactionUpdate(dataSearch);
  };

  exportFile = () => {
    const {
      getExcelFileReportUpdate,
    } = this.props;
    const {
      fromDate,
      toDate,
    ...
    if (fromDate.getTime() > toDate.getTime()) {
      ...
      getExcelFileReportUpdate(dataExport);
    }
  }
...
const mapStateToProps = (state) => ({
  ...
  exportReportFileUpdate: state.statisticalReport.exportReportFileUpdate,
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getExcelFileReportUpdate: (data) => dispatch(getExcelFileReportUpdate(data)),
...
FillReport.propTypes = {
  getDetailTransactionUpdate: PropTypes.func,
  getMerchantCodeName: PropTypes.func,
  listMerchantCodeName: PropTypes.array,
  getExcelFileReportUpdate: PropTypes.func,
  exportReportFileUpdate: PropTypes.object,
