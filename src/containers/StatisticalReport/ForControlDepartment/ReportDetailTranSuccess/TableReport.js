        ...
        <table className="fee-table__table">
          ...
          <tfoot>
            ...
            <tr className="total-tr">
              <td colSpan="4" className="text-bold text-center text-danger">{numberWithDots(listDetailTransactionMake && listDetailTransactionMake.totalAmount)}</td>
              <td colSpan="4" className="text-bold text-center text-danger">{numberWithDots(listDetailTransactionMake && listDetailTransactionMake.totalRealAmount)}</td>
            </tr>
          </tfoot>
        </table>
