...
import {getDetailTransactionSuccess, getExcelFileReport,} from '../../../../store/actions/StatisticalReport/index';
...
class FillReport extends Component {
  ...
  componentDidMount() {
    const {
      getDetailTransactionSuccess, getMerchantCodeName,
    } = this.props;
    const sendData = {
    ...
    getDetailTransactionSuccess(sendData);
  }
  ...
  componentDidUpdate(prevProps) {
    const { exportReportFile } = this.props;
    if (prevProps.exportReportFile !== exportReportFile) {
      window.open(exportReportFile, 'blank');
    }
  }
  ...
  onHandleSearch = () => {
    ...
    getDetailTransactionSuccess(dataSearch);
  };
...
const mapStateToProps = (state) => ({
  ...
  exportReportFile: state.statisticalReport.exportReportFile,
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getExcelFileReport: (data) => dispatch(getExcelFileReport(data)),
...
FillReport.propTypes = {
  getDetailTransactionSuccess: PropTypes.func,
  getMerchantCodeName: PropTypes.func,
  listMerchantCodeName: PropTypes.array,
  getExcelFileReport: PropTypes.func,
  exportReportFile: PropTypes.object,
