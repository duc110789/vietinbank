...
import {getDetailTransactionMmc, getExcelFileReportMmc,} from '../../../../store/actions/StatisticalReport/index';
...
class FillReport extends Component {
  ...
  componentDidMount() {
    const {
      getDetailTransactionMmc, getMerchantCodeName,
    } = this.props;
    const sendData = {
    ...
    getDetailTransactionMmc(sendData);
  }
  ...
  componentDidUpdate(prevProps) {
    const { exportReportFileMmc } = this.props;
    if (prevProps.exportReportFileMmc !== exportReportFileMmc) {
      window.open(exportReportFileMmc, 'blank');
    }
  }
  ...
  onHandleSearch = () => {
    ...
    if (fromDate.getTime() > toDate.getTime()) {
      ...
      getDetailTransactionMmc(dataSearch);
    }
  };

  exportFile = () => {
    const {
      getExcelFileReportMmc,
    } = this.props;
    const {
      fromDate,
      toDate,
    ...
    if (fromDate.getTime() > toDate.getTime()) {
      ...
      getExcelFileReportMmc(dataExport);
    }
  }
...
const mapStateToProps = (state) => ({
  ...
  exportReportFileMmc: state.statisticalReport.exportReportFileMmc,
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getExcelFileReportMmc: (data) => dispatch(getExcelFileReportMmc(data)),
...
FillReport.propTypes = {
  getDetailTransactionMmc: PropTypes.func,
  getMerchantCodeName: PropTypes.func,
  listMerchantCodeName: PropTypes.array,
  getExcelFileReportMmc: PropTypes.func,
  exportReportFileMmc: PropTypes.func,
