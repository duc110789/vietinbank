...
import {getDetailTransactionFail, getExcelFileReportError,} from '../../../../store/actions/StatisticalReport/index';
...
class FillReport extends Component {
  ...
  componentDidMount() {
    const {
      getDetailTransactionFail, getMerchantCodeName,
    } = this.props;
    const sendData = {
    ...
    getDetailTransactionFail(sendData);
  }
  ...
  componentDidUpdate(prevProps) {
    const { exportReportFileError } = this.props;
    if (prevProps.exportReportFileError !== exportReportFileError) {
      window.open(exportReportFileError, 'blank');
    }
  }
  ...
  onHandleSearch = () => {
    ...
    getDetailTransactionFail(dataSearch);
  };

  exportFile = () => {
    const {
      getExcelFileReportError,
    } = this.props;
    const {
      fromDate,
      toDate,
    ...
    getExcelFileReportError(dataExport);
  }
      ...
      <Row>
        ...
        <Col md="6">
          ...
          <FormGroup row>
            <Col lg="6" className="label-left">
              <Label>
                {Constants.StatisticalReport.status}
              </Label>
            </Col>
            <Col lg="6">
              <Select
...
const mapStateToProps = (state) => ({
  ...
  exportReportFileError: state.statisticalReport.exportReportFileError,
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getExcelFileReportError: (data) => dispatch(getExcelFileReportError(data)),
...
FillReport.propTypes = {
  getDetailTransactionFail: PropTypes.func,
  getMerchantCodeName: PropTypes.func,
  listMerchantCodeName: PropTypes.array,
  getExcelFileReportError: PropTypes.func,
  exportReportFileError: PropTypes.object,
